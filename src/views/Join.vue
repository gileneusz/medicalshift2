        ...
        <v-layout justify-center align-center>
          <v-card elevation="5" width="100%">
            <v-responsive :aspect-ratio="16 / 9">
              ...
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/HH-HCf90u8c" frameborder="0"
...
export default {
  data() {
    return {
      items: [
        {
          src: '/static/patent1.jpeg',
        },
        {
          src: '/static/patent2.jpeg',
        },
        {
          src: '/static/patent3.jpeg',
        },
        {
          src: '/static/patent4.jpeg',
        },
        {
          src: '/static/patent5.jpeg',
        },
        {
          src: '/static/patent6.jpeg',
        },
        {
          src: '/static/patent7.jpeg',
        }
      ],
    }
  },
